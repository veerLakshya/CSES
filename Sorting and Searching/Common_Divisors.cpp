...
// TC: O(NlogN)
// SC: O(N)
// Approach: We will iterate from N to 1 and for each i, we will check how many numbers are divisible by i.

// N/1 + N/2 + N/3 + N/4 + ... + N/N = N(1 + 1/2 + 1/3 + 1/4 + ... + 1/N) = NlogN (Harmonic Series)
